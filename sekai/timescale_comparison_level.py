...
# BPM 60 makes beats equal seconds. Start at 0.125s and include the 5s endpoint.
streams = [
    [
        LevelNote(
            beat=i * NOTE_STEP,
...
# The general builder links simultaneous taps; keep this comparison's stages independent.
